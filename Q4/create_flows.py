...
def create_flows(A, dir_name, C):
    n = A.shape[0]
    os.mkdir(dir_name)
    path_1_to_n, path_n_to_1 = dijkstra(C)
    ...
    for i in range(len(path_1_to_n)):
        ...
        with open(f'{dir_name}/{cnt}_1.json', 'w') as outfile:
        ...
        with open(f'{dir_name}/{cnt}_2.json', 'w') as outfile:
        ...
        for i in range(len(path_n_to_1)):
            ...
            with open(f'{dir_name}/{cnt}_3.json', 'w') as outfile:
                json.dump(arp, outfile)
            ...
            with open(f'{dir_name}/{cnt}_4.json', 'w') as outfile:
                json.dump(ip, outfile)